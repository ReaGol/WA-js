...
function nb_year(
  ...
  let currentPopulation = populationAtStart;
  let yearCounter = 0;
  while (currentPopulation < targetPopulation) {
    currentPopulation = currentPopulation + (currentPopulation * percentOfGrowth) / 100 + newInhabitants;
    yearCounter++;
  }
  return yearCounter;
}
console.log(nb_year(1000, 2, 50, 150000));
